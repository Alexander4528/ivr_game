...
try:
    ground_image = pygame.image.load('Sprites and objects/Objects, background and other/ground.jpg')
...
try:
    monster_image = pygame.image.load('Sprites and objects/Enemies/Enemy.png')
except:
...
try:
    died_image = pygame.image.load('Sprites and objects/Enemies/EnemyDead.png')
except:
