...
4. Если были сделаны сохранения, то счёт останется таким, каким был в момент сохранения игры.
...
- (от 100% до 50 % HP) Скорость ниже средней, атака в 1 HP(на легкой сложности).
...
5. При каждом переходе между фазами босс останавливается на 3 секунд и краснеет.
