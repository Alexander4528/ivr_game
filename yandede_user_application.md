...
* Подумал и сделал переход с первой части уровня, где надо дойти до портала(перехода между частями уровней, на вторую. 
* Смог сделать анимацию бега героя.
* Нашёл спрайты для других врагов.
* Продумал и реализовал сохранение на уровне.
* 
